...
//   // after refresh 
//   useEffect(() => {
//     if (socket && socket.readyState === WebSocket.OPEN && gameIdFromUrl) {
//       socket.send(JSON.stringify({
//         type: GameStatus.RESTORE_GAME,
//         payload: { gameId: gameIdFromUrl, username }
//       }));
//     } else if (socket && gameIdFromUrl) {
//       const handleOpen = () => {
//         socket.send(JSON.stringify({
//           type: GameStatus.RESTORE_GAME,
//           payload: { gameId: gameIdFromUrl , username }
...
//       console.log('Trying to restore game with:', gameIdFromUrl);
...
//           router.replace(`/game?gameId=${gameId}`); // <- Add this line
//           break;
...
//             setColour(color === 'white' ? 'w' : 'b');
//             setOpponentName(color === 'white' ? blackPlayer : whitePlayer);
//             setGameId(gameId);
//             setMoves(moves);
//             setStartingTime(timerValue); // optional: can be dynamic from payload
          
//             chess.load(currentFen as string); // load restored position
//             setBoard(chess.board());
          
//             setWhitePlayerTime(remainingTime.player1);
//             setBlackPlayerTime(remainingTime.player2);
//             setIsGameStarted(true);
...
const Page = () => {
  ...
  }, [moves, gameStarted, result, chess]);
