  ...
  return (
    <div>
      <div className='dark:bg-slate-800/30 bg-gray-800/50 border border-slate-400 rounded-md p-8 relative  backdrop-blur-sm shadow-lg back backdrop-sepia backdrop-opacity-30 '>
        ...
        <button   className='w-full mb-4 text-2xl mt-6 rounded-full py-2 bg-cyan-700 text-white hover:bg-cyan-900 cursor-pointer transition-colors duration-300'>Login</button>
