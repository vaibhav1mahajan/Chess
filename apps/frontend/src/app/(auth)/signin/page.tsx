    ...
    <div>
      <div className='bg-slate-800/30 border border-slate-400 rounded-md p-8 relative  backdrop-blur-sm shadow-lg back backdrop-sepia backdrop-opacity-30 '>
        ...
        <div className='relative my-4'>
         <input type="text"  className='peer block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-b-2 focus:border-blue-600 peer' placeholder=' '/>
        ...
        <div className='relative my-4'>
         <input type="password" className='peer block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-b-2 focus:border-blue-600 peer' placeholder=' '/>
        ...
        <button type='submit' className='w-full mb-4 text-2xl mt-6 rounded-full py-2 bg-cyan-700 text-white hover:bg-cyan-900 cursor-pointer transition-colors duration-300'>Login</button>
        <span className='mt-4'>New Here? &nbsp; <Link className='text-blue-500' href='/signup'> Create an Account</Link></span>
        </form>
      </div>
    </div>
  )
